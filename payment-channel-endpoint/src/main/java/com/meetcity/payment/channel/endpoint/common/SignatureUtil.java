package com.meetcity.payment.channel.endpoint.common;
...
public class SignatureUtil {
    ...
    public static String getSignFromResponseString(String responseString, String key) {
        Map<String, Object> map = JSON.parseObject(responseString, Map.class);
    ...
    public static boolean checkSign(String responseString, String key) {
        ...
        Map<String, Object> map = JSON.parseObject(responseString, HashMap.class);
